  ...
  <div class="login-container login-v2">
      ...
      <div class="login-box animated fadeInDown" style="animation-duration: 1s;">
          <div class="login-body">
              <div class="login-title"><strong>{!!trans('messages.Welcome')!!}</strong>, {!!trans('auth.Please login')!!}.</div>
              ...
              <div class="form-group">
                  <div class="col-md-6">
                      <a href="#">{!! trans('auth.Forgot your password?') !!}</a>
                  </div>          
                  <div class="col-md-6 text-right">
                      <a href="#">{!! trans('auth.Create an Account') !!}</a>
                  </div>              
              </div>
              <div class="form-group">
                  <div class="col-md-12">
                      <button class="btn btn-primary btn-lg btn-block"> {!! trans('auth.Login') !!}</button>
                  </div>
              </div>
              {{ Form::close() }}
          </div>
