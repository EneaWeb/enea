        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!!Form::open(['url'=>'/admin/types/update', 'method'=>'GET', 'class'=>'form-horizontal', 'role'=>'form'])!!}
                        @foreach(\App\Type::all() as $type)
                            <div class="form-group">
                                <label class="col-md-2 col-lg-1 control-label">{!!trans('messages.'.ucwords($type->name))!!}</label>
                    ...
                    <div class="form-group">
                    <br><br>
                        {!!Form::submit(trans('auth.Update'),['class'=>'btn btn-warning btn-lg'])!!}
                    </div>
                    {!!Form::close()!!}
                    <br><br><br>
                </div>
