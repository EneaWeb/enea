        ...
        <div class="modal-dialog animated zoomIn">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="smallModalHead">{!! trans('menu.New Size') !!}</h4>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form-horizontal form-group-separated">                        
                        <div class="form-group">
                            {!!Form::label('name', trans('auth.Name').'*', ['class' => 'col-md-3 control-label'])!!}
                            <div class="col-md-8">
                                {!!Form::input('text', 'name', $size->name, ['class' => 'form-control', 'placeholder' => trans('auth.Name')])!!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!!Form::label('slug', trans('menu.Slug'), ['class' => 'col-md-3 control-label'])!!}
                            <div class="col-md-8">
                                {!!Form::input('text', 'slug', $size->slug, ['class' => 'form-control', 'placeholder' => trans('menu.Slug')])!!}
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
