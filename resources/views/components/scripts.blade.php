<script>
    ...
    function confirm_unlink_user(userid){
        alertify.confirm( "{!!trans('x.Please Confirm')!!}", "{!!trans('x.Are you sure you want to unlink the user from your brand?')!!}", 
            function () {
                // positive
    ...
    function confirm_delete_delivery(id){
        alertify.confirm( "{!!trans('x.Please Confirm')!!}", "{!!trans('x.Are you sure you want to delete this date?')!!}", 
            function () {
                // positive
    ...
    function confirm_delete_product(id){
        alertify.confirm( "{!!trans('x.Please Confirm')!!}", "{!!trans('x.Are you sure you want to delete this product?')!!}", 
            function () {
                // positive
    ...
    function confirm_delete_payment(id){
        alertify.confirm( "{!!trans('x.Please Confirm')!!}", "{!!trans('x.Are you sure you want to delete this payment option?')!!}", 
            function () {
                // positive
                window.location.href = "/settings/payment/delete/"+id;
            }, 
            function() {
                ; // negative// do nothing 
            }
    ...
    function confirm_delete_model(id){
        alertify.confirm( "{!!trans('x.Please Confirm')!!}", "{!!trans('x.Are you sure you want to delete this model?')!!}", 
            function () {
                // positive
    ...
    function confirm_delete_variation(id){
        alertify.confirm( "{!!trans('x.Please Confirm')!!}", "{!!trans('x.Are you sure you want to delete this variation?')!!}", 
            function () {
                // positive
    ...
    function confirm_delete_color(id){
        alertify.confirm( "{!!trans('x.Please Confirm')!!}", "{!!trans('x.Are you sure you want to delete this color?')!!}", 
            function () {
                // positive
    ...
    function confirm_delete_size(id){
        alertify.confirm( "{!!trans('x.Please Confirm')!!}", "{!!trans('x.Are you sure you want to delete this size?')!!}", 
            function () {
                // positive
    ...
    function confirm_delete_customer_delivery(id){
        alertify.confirm( "{!!trans('x.Please Confirm')!!}", "{!!trans('x.Are you sure you want to delete this option?')!!}", 
            function () {
                // positive
