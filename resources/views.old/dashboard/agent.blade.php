                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            {!!trans('x.Personal Orders')!!}: <span class="label label-info label-form">{!!strtoupper(Auth::user()->options->brand_in_use->name)!!}</span>
                        </h3>
