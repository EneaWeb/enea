...
<div id="container" style="width:100%;">
    ...
    <table style="width:100%; border-collapse:collapse;">
        <tr>
            <td style="width:50%; border:2px solid black; padding:10px">
                <h3>{!!strtoupper(trans('x.Waybill'))!!} N. {!!$number!!}</h3>
            </td>
            <td style="width:50%; border:2px solid black; padding:10px">
    ...
    <table style="width:100%; border-collapse:collapse;">
        <tr>
            ...
            <td style="border:2px solid black; padding:10px">
                <h4>{!!trans('x.N. Packages')!!}: {!!$n_colli!!}</h4>
            </td>
            <td style="border:2px solid black; padding:10px">
                <h4>{!!trans('x.Weight')!!}: {!!$weight!!}</h4>
            </td>
        </tr>
        <tr>
            <td style="border:2px solid black; padding:10px">
                <br>
                <h4>{!!trans('x.Courier')!!}: {!!$shipper!!}</h4>
            </td>
            <td colspan="2" style="border:2px solid black; padding:10px">
                <br>
                {!!trans('x.Picking date/hour')!!}: 
            </td>
        </tr>
        <tr>
            <td style="border:2px solid black; padding:10px">
                <br>{!!trans('x.Picking sign')!!}: <br>
            </td>
            <td colspan="2" style="border:2px solid black; padding:10px">
                <br>{!!trans('x.Delivery sign')!!}: <br>
            </td>
        </tr>
    </table>
    <br><br>
