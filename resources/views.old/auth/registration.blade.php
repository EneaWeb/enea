        ...
        <div class="registration-box animated fadeInDown">
            ...
            <div class="registration-body" style="color:#a4a6aa">
                ...
                {!!Form::open(['url'=>'/registration/confirm-registration', 'method'=>'POST'])!!}
                    ...
                    <div class="col-md-6">
                        <div class="registration-title">&nbsp;&nbsp;<strong>{!!trans('x.Temporary login informations')!!}</strong></div>
                        <br>
                    ...
                    <div class="col-md-6">
                        <div class="registration-title">&nbsp;&nbsp;<strong>{!!trans('x.Personal Informations')!!}</strong></div>
                        <div class="registration-subtitle"> {!!trans('x.Please fill all the fields below')!!} </div>
                        <br>
                        
                        <div class="form-group">
                            <div class="col-md-12">
                                {!!Form::label('new_username', trans('x.New Username'))!!}
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                {!!Form::label('new_password', trans('x.New Password'))!!}
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                {!!Form::label('confirm_new_password', trans('x.Confirm New Password'))!!}
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                {!!Form::label('companyname', trans('x.Company Name'))!!}
                        ...
                        <div class="form-group push-up-30">
                            ...
                            <div class="col-md-6">
                                {!!Form::submit(trans('x.Confirm'), ['class'=>'btn btn-danger btn-block'])!!}
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
