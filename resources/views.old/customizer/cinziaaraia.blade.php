   ...
   <div class="panel panel-default">
   	<div class="panel-body">
	   	<div class="pannello-body" style="padding:20px">
	   		...
	   		<p id="description-option">[TomaiaUp] <strong><span id="option-tomaiaup">CROSTA ANGEL</span></strong> <br>[TomaiaDown] <strong><span id="option-tomaiadown">TESSUTO BLACK</span></strong> <br>[Tacco] <strong><span id="option-tacco">PELLE BLACK</span></strong> <br>[Suola] <strong><span id="option-suola">GESSO</span></strong> <br>[Scritta] <strong><span id="option-scritta">WHITE</span></strong> <br>[Logo] <strong><span id="option-logo">BLACK</span></strong></p>
	   		<br>
	   			<a class="gallery-item" href="#" data-toggle="modal" data-target="#modal_add_line_{!!$product->id!!}" class="tile tile-primary">
...
<div class="modal animated fadeIn" id="modal_add_line_{!!$product->id!!}" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true" style="display: none;">
    ...
    <div class="modal-dialog animated zoomIn">
        ...
        <div class="modal-content">
            ...
            <div class="panel-body tab-content">
                ...
                <br>
                {!!Form::textarea('custom', '', ['rows'=>'3', 'id'=>'description-option-copy', 'class'=>'form-control', 'style'=>'max-width:720px; margin-left:auto; margin-right:auto'])!!}
                <br><br><br>
            </div>
                ...
                <script>
                    $(document).ready(function(){
                    		$(window).click(function(){
                    			var descriptionOption = $('#description-option').text();
                    			$('#description-option-copy').val(descriptionOption);
                    		});
