    ...
    <div class="page-content-wrap">
        ...
        <div class="row">                        
            ...
            <div class="col-md-6 col-sm-8 col-xs-7">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <h3><span class="fa fa-pencil"></span> {!!trans('x.Profile')!!}</h3>
                        <p></p>
                    </div>
                    <div class="panel-body form-group-separated">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-xs-5 control-label">{!!trans('x.Surname')!!}</label>
                            <div class="col-md-9 col-xs-7">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-xs-5 control-label">{!!trans('x.Bio')!!}</label>
                            <div class="col-md-9 col-xs-7">
        ...
        <div class="modal animated fadeIn" id="modal_change_password" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body form-horizontal form-group-separated">
                        <div class="form-group">
                            {!!Form::label('old_password', trans('x.Old Password'), ['class'=>'col-md-3 control-label'])!!}
                            <div class="col-md-9">
                                {!!Form::input('text', 'old_password', '', ['class'=>'form-control'])!!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!!Form::label('new_password', trans('x.New Password'), ['class'=>'col-md-3 control-label'])!!}
                            <div class="col-md-9">
                                {!!Form::input('text', 'new_password', '', ['class'=>'form-control'])!!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!!Form::label('confirm_new_password', trans('x.Confirm New Password'), ['class'=>'col-md-3 control-label'])!!}
                            <div class="col-md-9">
