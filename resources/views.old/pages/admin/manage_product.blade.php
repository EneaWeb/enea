            ...
            <div class="panel panel-default">
                <div class="panel-body">                            
                    <div class="tocify-content">                        
                        ...
                        <div class="form-group">
                            <div class="col-md-8">
                                {!!Form::submit(trans('x.Update'), ['class'=>'btn btn-main'])!!}
                            </div>
                        </div>
                ...
                {!!Form::hidden('id', $product->id)!!}
                    <div class="panel-body">                            
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!!Form::select('has_variations', ['1'=>trans('x.Yes'), '0'=>trans('x.No')], $product->has_variations, ['class' => 'form-control', 'placeholder' => trans('x.Select')])!!}
                            </div>
                        </div>
                        <br><br>
                        <div class="form-group">
                    ...
                    {!!Form::open(['url'=>'/catalogue/products/add-main-picture', 'method'=>'POST', 'novalidate' => 'novalidate', 'files' => true])!!}
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                {!!Form::submit(trans('x.Save'), ['class'=>'btn btn-main'])!!}
                            </div>
