                        ...
                        <div class=""> {{-- multiply this --}}
                            ...
                            <div class="widget-data">
                                ...
                                <div class="widget-title">
                                    {!! trans('x.Active users') !!}
                                </div>
                                <div class="widget-subtitle">
                                    {!! trans('x.On brand') !!} {!!strtoupper(Auth::user()->options->brand_in_use->name)!!}
                                </div>
                            </div>                         
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            {!!trans('x.Active Users for brand')!!}: <span class="label label-info label-form">{!!strtoupper(Auth::user()->options->brand_in_use->name)!!}</span>
                        </h3>
            ...
            <div class="modal-body form-horizontal form-group-separated">         
                <div class="form-group">
                    @if (Auth::user()->can('manage brands'))
                        ...
                        <div class="col-md-8">
                            {!!Form::select('role', \App\Role::where('name', '!=', 'superuser')->pluck('name', 'name'), '', ['class' => 'form-control', 'placeholder' => trans('x.Select Role')])!!}
                        </div>
                    @endif
                </div>             
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        {!!Form::select('season_list_id', \App\SeasonList::return_user_lists(), '', ['class'=>'selectpicker', 'multiple'=>'multiple', 'name'=>'season_list_id[]'])!!}
                    </div>
                </div>
                <div class="form-group">
