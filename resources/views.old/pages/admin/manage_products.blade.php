                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            {!!trans('x.Products for brand')!!}: <span class="label label-info label-form">{!!strtoupper(Auth::user()->options->brand_in_use->name)!!}</span>
                        </h3>
    ...
    <div class="modal-dialog animated zoomIn">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="smallModalHead">{!! trans('x.Add new Product') !!}</h4>
            </div>
            ...
            <div class="modal-body form-horizontal form-group-separated"> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        {!!Form::select('type_id', \App\Type::lists('slug', 'id'), '', ['class' => 'form-control', 'placeholder'=>trans('x.Select')])!!}
                    </div>
                </div>
                <div class="form-group">
                    {!!Form::label('prodmodel_id', trans('x.Model'), ['class' => 'col-md-3 control-label'])!!}
                    <div class="col-md-8">
                        {!!Form::select('prodmodel_id', \App\ProdModel::lists('name', 'id'), '', ['class' => 'form-control', 'placeholder' => trans('x.Select Model')])!!}
                    </div>
                </div>             
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        {!!Form::select('has_variations', ['1'=>trans('x.Yes'), '0'=>trans('x.No')], '', ['class' => 'form-control', 'placeholder' => trans('x.Select')])!!}
                    </div>
                </div>
                <div class="form-group">
                    {!!Form::label('description', trans('x.Description'), ['class' => 'col-md-3 control-label'])!!}
                    <div class="col-md-8">
                        {!!Form::textarea('description', '', ['class' => 'form-control', 'placeholder' => trans('x.Description')])!!}
                    </div>
                </div>
            </div>
