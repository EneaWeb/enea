        ...
        <div class="content-frame-left">
            ...
            <div class="col-md-12" style="padding:0">
                ...
                <div class="widget widget-warning widget-no-subtitle">
                    <div class="widget-subtitle">{!! trans('x.Payment Options') !!}</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-horizontal form-group-separated">                        
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {!!Form::select('action', [''=>trans('x.None'), '+'=>trans('x.Increase'), '-'=>trans('x.Discount')], '', ['class' => 'form-control', 'placeholder' => trans('x.Select')])!!}
                        </div>
                    </div>
                    <div class="form-group">
