                        ...
                        <div class="panel-content">
                            ...
                            <div class="modal-body form-horizontal form-group-separated">
                                ...
                                <div class="form-group">
                                    {!!Form::label('customer_delivery_id', trans('x.Select a Delivery address').'*', ['class' => 'col-md-3 control-label'])!!}
                                ...
                                <div class="form-group">
                                    {!!Form::label('payment_id', trans('x.Select Price list').'*', ['class' => 'col-md-3 control-label'])!!}
                                    <div class="col-md-6 col-xs-12">   
                            ...
                            <div class="modal-body form-horizontal form-group-separated">
                                <br>                      
                                <div class="form-group">
                                    {!!Form::label('companyname', trans('x.Click to continue'), ['class' => 'col-md-3 control-label'])!!}
                                    <div class="col-md-6 col-xs-12">
                                        {!!Form::submit(trans('x.Continue'), ['class'=>'btn btn-danger'])!!}
                                    </div>
                                    <div class="clearfix"></div><br>
                                </div>
                            </div>
