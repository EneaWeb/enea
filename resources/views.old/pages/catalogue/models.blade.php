        ...
        <div class="content-frame-left">
            ...
            <div class="col-md-12" style="padding:0">
                ...
                <div class="widget widget-warning widget-no-subtitle">
                    <div class="widget-subtitle">{!! trans('x.Models') !!}</div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form-horizontal form-group-separated">                        
                        ...
                        <div class="form-group">
                            {!!Form::label('slug', trans('x.Slug'), ['class' => 'col-md-3 control-label'])!!}
                            <div class="col-md-8">
                                {!!Form::input('text', 'slug', $model->slug, ['class' => 'form-control', 'placeholder' => trans('x.Slug')])!!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!!Form::label('type_id', trans('x.Type'), ['class' => 'col-md-3 control-label'])!!}
