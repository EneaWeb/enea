    ...
    <div class="content-frame">
        <div class="content-frame-right">
            <div class="panel-heading">
                <h3 style="display:inline-block">{!! trans('x.Attributes')!!}</h3>
            ...
            <div class="panel panel-default">
                <a data-toggle="collapse" href="#new-attribute-value" class="list-group-item">
                    <h3 class="no-margin-bottom">{!! trans('x.New Value')!!}</h3>
                </a>
                    ...
                    <div id="new-attribute-value" class="collapse">
                        {!! Form::open(['url'=> '/catalogue/attribute-values/new', 'method'=>'POST', 'class'=>'form-material'])!!}
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::label('attribute_id', trans('x.Attribute'))!!}
                            </div>
                            
                            <div class="form-group">
                                {!!Form::input('text', 'name', '', ['class'=>'form-control'])!!}
                                {!!Form::label('name', trans('x.Value Name'))!!}
                            </div>
                            
                            <div class="form-group">
                                {!!Form::input('text', 'slug', '', ['class'=>'form-control'])!!}
                                {!!Form::label('slug', trans('x.Value Slug'))!!}
                            </div>
                            
                            <div class="form-group">
                                {!!Form::submit(trans('x.Submit'), ['class'=>'btn btn-danger'])!!}
                            </div>                     
    ...
    <div class="modal-dialog animated zoomIn">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="smallModalHead">{!! trans('x.New Attribute') !!}</h4>
            </div>
