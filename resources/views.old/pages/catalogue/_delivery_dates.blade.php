<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">{!!trans('x.Delivery Dates')!!}</h3>      
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-horizontal form-group-separated">                        
                    <div class="form-group">
                        {!!Form::label('name', trans('x.Name').'*', ['class' => 'col-md-3 control-label'])!!}
                        <div class="col-md-8">
                            {!!Form::input('text', 'name', $delivery_date->name, ['class' => 'form-control', 'placeholder' => trans('x.Name')])!!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!!Form::label('slug', trans('x.Slug'), ['class' => 'col-md-3 control-label'])!!}
                        <div class="col-md-8">
                            {!!Form::input('text', 'slug',  $delivery_date->slug, ['class' => 'form-control', 'placeholder' => trans('x.Slug')])!!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!!Form::label('date', trans('x.Date'), ['class' => 'col-md-3 control-label'])!!}
