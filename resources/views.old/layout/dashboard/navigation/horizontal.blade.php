...
<ul class="x-navigation x-navigation-horizontal x-navigation-panel">
    ...
    <li class="xn-icon-button pull-right last">
        ...
        <ul class="xn-drop-left animated zoomIn">
            ...
            <li><a href="/logout"><span class="fa fa-sign-out"></span> {!!trans('x.Sign Out')!!}</a></li>
        </ul>                        
    </li> 
    {{-- END POWER OFF --}}         
    ...
    {{-- TYPE BAR --}}
    <li class=" pull-right">
        <a href="#"><span class="fa fa-venus-mars"></span>{!!ucfirst(trans('x.'.Auth::user()->options->type_in_use->slug))!!}</a>
        <ul class="xn-drop-left xn-drop-white animated zoomIn" style="max-width:160px">
            <li><a href="/set-current-type/1"><span class="glyphicon glyphicon-play"></span>{!!ucfirst(trans('x.all'))!!}</a></li>
            <li><a href="/set-current-type/5"><span class="glyphicon glyphicon-play"></span>{!!ucfirst(trans('x.woman'))!!}</a></li>
            <li><a href="/set-current-type/4"><span class="glyphicon glyphicon-play"></span>{!!ucfirst(trans('x.man'))!!}</a></li>
        </ul>                        
    </li>
    {{-- END TYPE BAR --}}
